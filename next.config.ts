...
const securityHeaders = [
  ...
  // Next.js requires 'unsafe-inline' for styled-jsx
  {
    ...
    value: [
      ...
      "media-src 'self' blob: https: https://www.youtube-nocookie.com https://*.public.blob.vercel-storage.com",
      "connect-src 'self' https://api.github.com https://*.public.blob.vercel-storage.com",
